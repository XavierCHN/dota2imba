...
function GameMode:PostLoadPrecache()
  print("[DOTA2IMBA] Performing Post-Load precache")    
...
function GameMode:OnFirstPlayerLoaded()
  print("[DOTA2IMBA] First Player has loaded")
end
...
function GameMode:OnAllPlayersLoaded()
  print("[DOTA2IMBA] All Players have loaded into the game")
end
...
function GameMode:OnGameInProgress()
  print("[DOTA2IMBA] The game has officially begun")
...
function GameMode:OnDisconnect(keys)
  print('[DOTA2IMBA] Player Disconnected ' .. tostring(keys.userid))
  PrintTable(keys)
...
function GameMode:OnGameRulesStateChange(keys)
  print("[DOTA2IMBA] GameRules State Changed")
  PrintTable(keys)
...
function GameMode:OnItemPickedUp(keys)
  print ( '[DOTA2IMBA] OnItemPurchased' )
  PrintTable(keys)
...
function GameMode:OnPlayerReconnect(keys)
  print ( '[DOTA2IMBA] OnPlayerReconnect' )
  PrintTable(keys) 
end
...
function GameMode:OnNonPlayerUsedAbility(keys)
  print('[DOTA2IMBA] OnNonPlayerUsedAbility')
  PrintTable(keys)
...
function GameMode:OnPlayerChangedName(keys)
  print('[DOTA2IMBA] OnPlayerChangedName')
  PrintTable(keys)
...
function GameMode:OnPlayerLearnedAbility( keys)
  print ('[DOTA2IMBA] OnPlayerLearnedAbility')
  PrintTable(keys)
...
function GameMode:OnAbilityChannelFinished(keys)
  print ('[DOTA2IMBA] OnAbilityChannelFinished')
  PrintTable(keys)
...
function GameMode:OnPlayerLevelUp(keys)
  print ('[DOTA2IMBA] OnPlayerLevelUp')
  PrintTable(keys)
...
function GameMode:OnRuneActivated (keys)
  print ('[DOTA2IMBA] OnRuneActivated')
  PrintTable(keys)
...
function GameMode:OnPlayerTakeTowerDamage(keys)
  print ('[DOTA2IMBA] OnPlayerTakeTowerDamage')
  PrintTable(keys)
...
function GameMode:OnPlayerPickHero(keys)
  print ('[DOTA2IMBA] OnPlayerPickHero')
  PrintTable(keys)
...
function GameMode:OnTeamKillCredit(keys)
  print ('[DOTA2IMBA] OnTeamKillCredit')
  PrintTable(keys)
...
function GameMode:OnEntityKilled( keys )
  print( '[DOTA2IMBA] OnEntityKilled Called' )
  PrintTable( keys )
...
function GameMode:InitGameMode()
  GameMode = self
  print('[DOTA2IMBA] Starting to load DOTA2IMBA gamemode...')
  ...
  print('[DOTA2IMBA] GameRules set')

  InitLogFile( "log/DOTA2IMBA.txt","")
  ...
  Convars:RegisterCommand('fake', function()
    ...
    if not Convars:GetCommandClient() then
      ...
      Timers:CreateTimer('assign_fakes', {
        useGameTime = false,
        endTime = Time(),
        callback = function(DOTA2IMBA, args)
          local userID = 20
          for i=0, 9 do
            userID = userID + 1
  ...
  print('[DOTA2IMBA] Done loading DOTA2IMBA gamemode!\n\n')
end
